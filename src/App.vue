...
<script>
  export default {
    ...
    mounted() {
      ...
      // window.addEventListener("resize", me.resize(canvas, ctx));
    },
    ...
    methods: {
      ...
      draw(canvas, ctx) {
        ...
        img.onload = function() {
          ...
          me.drawImageProp(ctx, img, 0, 0, w, h, offsetX, offsetY);
          // ctx.drawImage(img, 0, 0, img.width, img.height, 0, 0, canvas.width, canvas.height);

          // me.animate1(canvas, ctx, img, w, h);
          me.animate2(ctx, img, w, h);
        }
      },
      animate1(canvas, ctx, img, w, h) {
        var me = this;
        var o1 = new me.Osc(0.05), o2 = new me.Osc(0.03), o3 = new me.Osc(0.06),  // osc. for vert
            o4 = new me.Osc(0.08), o5 = new me.Osc(0.04), o6 = new me.Osc(0.067), // osc. for hori
      ...
      animate2(ctx, img, w, h) {
        var me = this;
        var o1 = new me.Osc(0.05), o2 = new me.Osc(0.03), o3 = new me.Osc(0.06),
            x0 = 0, x1 = w * 0.25, x2 = w * 0.5, x3 = w * 0.75, x4 = w;
